...
stock_code_list = ['sh600352', 'sz000001', 'sh600356','sh600331', 'sz002850' ,'sh601005', 'sz300748', 'sh600641', 'sz000623', 'sz300617', 'sz002414'] #在后面添加,' '即可，注意一定要用英文符号
...
# =====保存数据
df.to_csv('rick_stock_data.csv', index=False)
